...
- `Sandbox.Services.Stats.PlayerStat Item`

## Methods

### Instance methods

- `Sandbox.Services.Stats.PlayerStats Copy()`
  - Make a copy of this class. Allows you to store the stats from a point in time.
- `Sandbox.Services.Stats.PlayerStat Get(System.String name)`
  - Get a stat by name. Will return an empty stat if not found
- `System.Boolean TryGet(System.String name, Sandbox.Services.Stats.PlayerStat stat)`
...
- `virtual System.Collections.Generic.IEnumerator<Sandbox.Services.Stats.PlayerStat> GetEnumerator()`
